...
public class WestminsterHotelManager implements HotelManager {
    ...
    public boolean runMenu() {
        ...
        System.out.println("To Remove a staff member press 4");
        ...
        if (hotelStaffList.size() < staffLimit) {
            ...
            switch (choiceStaff) {
                ...
                case 3:
                    ...
                    System.out.println("Enter the working shift (Day /Night)");
                    String workingShift = s.next();
                    s.nextLine();


                    Receptionist receptionist = new Receptionist(name, surname, workingShift);
                    receptionist.setWorkingShift(workingShift);
    ...
    public boolean removeStaffFromList(){
        Scanner s = new Scanner(System.in);
        System.out.println("Enter staffID of the staff member to be removed:");
        String staffId = s.next();

        if (!staffId.isEmpty()){
            for (int i = 0; i < staffLimit; i++){
